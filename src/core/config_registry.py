...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "EXTERNAL_TOOL_ENABLED": {
        "title": "External Tool Research",
        "description": "Enable the optional external-tool research workspace. Disabled by default and isolated from DSA's original analysis flow.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 19,
        "help_key": "settings.data_source.EXTERNAL_TOOL_ENABLED",
        "examples": ["EXTERNAL_TOOL_ENABLED=false", "EXTERNAL_TOOL_ENABLED=true"],
        "docs": [{
            "label": "外部工具扩展说明",
            "href": "docs/extensions/external-tool/README.md",
        }],
    },
    "EXTERNAL_TOOL_DATA_DIR": {
        "title": "External Tool Data Directory",
        "description": "Runtime data directory used by the installed external tool. This is not a source-code path.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "data/external_tool",
        "options": [],
        "validation": {},
        "display_order": 20,
        "help_key": "settings.data_source.EXTERNAL_TOOL_DATA_DIR",
        "examples": ["EXTERNAL_TOOL_DATA_DIR=data/external_tool"],
        "docs": [{
            "label": "外部工具本地配置",
            "href": "docs/extensions/external-tool/SETUP.md",
        }],
    },
    "EXTERNAL_TOOL_ADAPTER_MODULE": {
        "title": "External Tool Adapter Module",
        "description": "Import path of the installed external-tool adapter module.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": True,
        ...
        "validation": {},
        "display_order": 21,
        "help_key": "settings.data_source.EXTERNAL_TOOL_ADAPTER_MODULE",
        "examples": ["EXTERNAL_TOOL_ADAPTER_MODULE=your_package.adapter"],
        "docs": [{
            "label": "外部工具适配配置",
            "href": "docs/extensions/external-tool/SETUP.md",
        }],
    ...
    "EXTERNAL_TOOL_AUTOMATION_CONFIG": {
        "title": "External Tool Automation Config",
        "description": "Versioned, non-secret daily report configuration used by automation.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "automation/daily-report.yaml",
        "options": [],
        "validation": {},
        "display_order": 22,
        "help_key": "settings.data_source.EXTERNAL_TOOL_AUTOMATION_CONFIG",
        "examples": ["EXTERNAL_TOOL_AUTOMATION_CONFIG=automation/daily-report.yaml"],
        "docs": [{
            "label": "外部工具自动化配置",
            "href": "docs/extensions/external-tool/SETUP.md",
        }],
    },
    "EXTERNAL_TOOL_CONTRACT_MIN": {
        "title": "External Tool Minimum Contract",
        "description": "Minimum external-tool adapter contract version accepted by this DSA fork.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "validation": {"min": 1},
        "display_order": 23,
        "help_key": "settings.data_source.EXTERNAL_TOOL_CONTRACT_MIN",
        "examples": ["EXTERNAL_TOOL_CONTRACT_MIN=1"],
        "docs": [{
            "label": "外部工具合同规范",
            "href": "docs/extensions/external-tool/SPEC.md",
        }],
    },
    "EXTERNAL_TOOL_CONTRACT_MAX": {
        "title": "External Tool Maximum Contract",
        "description": "Maximum external-tool adapter contract version accepted by this DSA fork.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "validation": {"min": 1},
        "display_order": 24,
        "help_key": "settings.data_source.EXTERNAL_TOOL_CONTRACT_MAX",
        "examples": ["EXTERNAL_TOOL_CONTRACT_MAX=1"],
        "docs": [{
            "label": "外部工具合同规范",
            "href": "docs/extensions/external-tool/SPEC.md",
        }],
